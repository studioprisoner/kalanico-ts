...
export default function Success() {
    ...
    return (
        <Layout title="Kalani Co | Success - Thank you for your purchase">
        <div>
            ...
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div>
                    ...
                    <div className="mt-2">
                        ...
                        Thank you for your purchase! You will receive an email with details of your purchase and we'll be in contact for a delivery time.
                        </p>
                    </div>
                    </div>
                </div>
